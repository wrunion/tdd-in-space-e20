...
describe('Person', () => {
  ...
  test(`earthLifeExpectancy function should return 70 for "male", 74 for "female", and "72" for other and default, if no value is passed in, or if a non-string is passed in`, () => {
    ...
    let personWithFaultyGenderInput = new Person('Chris', 25, 32);
    expect(personWithFaultyGenderInput.earthLifeExpectancy()).toEqual(72);
  });
